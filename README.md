...
> **Live Web Dashboard:** [https://india-internship-availability-checker.vercel.app](index.html) *(Updated: 2026-08-10 18:38:06 IST)*

---

## 📊 Live Overview & Quick Metrics
- ⚡ **Total Active Roles (India):** `476`
- 🎓 **Indian Internships & Trainee Roles:** `49`
- 🔥 **High PPO / FTE Conversion Roles:** `34`
- 🤖 **AI / ML & GenAI Opportunities:** `134`
- 💻 **Software & Systems Engineering Roles:** `323`
...
- 🎓 **[View All Indian Internships](INTERNSHIPS_INDIA.md)** (`49` open)
- 🤖 **[View All AI & ML Roles](AI_AND_ML_ROLES.md)** (`134` open)
- 💻 **[View All SDE & Systems Roles](SDE_AND_SYSTEMS.md)** (`323` open)
