...
- ⚡ **Total Active Roles (India):** `866`
- 🎓 **Indian Internships & Trainee Roles:** `98`
- 🔥 **High PPO / FTE Conversion Roles:** `65`
- 🤖 **AI / ML & GenAI Opportunities:** `252`
- 💻 **Software & Systems Engineering Roles:** `577`
...
- 🤖 **[View All AI & ML Roles](AI_AND_ML_ROLES.md)** (`252` open)
- 💻 **[View All SDE & Systems Roles](SDE_AND_SYSTEMS.md)** (`577` open)
