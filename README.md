...
> **Live Web Dashboard:** [https://india-internship-availability-checker.vercel.app](index.html) *(Updated: 2026-08-21 00:28:27 IST)*

---

## 📊 Live Overview & Quick Metrics
- ⚡ **Total Active Roles (India):** `596`
- 🎓 **Indian Internships & Trainee Roles:** `60`
- 🔥 **High PPO / FTE Conversion Roles:** `42`
- 🤖 **AI / ML & GenAI Opportunities:** `180`
- 💻 **Software & Systems Engineering Roles:** `394`
...
- 🎓 **[View All Indian Internships](INTERNSHIPS_INDIA.md)** (`60` open)
- 🤖 **[View All AI & ML Roles](AI_AND_ML_ROLES.md)** (`180` open)
- 💻 **[View All SDE & Systems Roles](SDE_AND_SYSTEMS.md)** (`394` open)
